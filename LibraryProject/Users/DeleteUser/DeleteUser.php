        ...
        else
        {
            ...
            if(!$ligne)
            {
                ...
                echo "<script language=\"javascript\">
                     ...
                     window.location.href='http://localhost/libraryproject/Users/DeleteUser/DeleteUser.html' ;
                     </script>" ;
            }
            else
            {
                      ...
                      <div class=\"form-style-5\">
                        <form method=\"post\" action=\"DeleteUser2.php\">
                            <fieldset>
                                ...
                                <input type=\"text\" name=\"userFName\" placeholder=\"First Name *\" value=\"$tab[1]\" readonly>
                                <input type=\"text\" name=\"userLName\" placeholder=\"Last Name *\" value=\"$tab[2]\" readonly>
                                <input type=\"text\" name=\"userAddress\" placeholder=\"Address *\" value=\"$tab[3]\" readonly>
                                <input type=\"text\" name=\"userStatus\" placeholder=\"Status *\" value=\"$tab[4]\" readonly>
                                <input type=\"text\" name=\"userEmail\" placeholder=\"Email *\" value=\"$tab[5]\" readonly>
