                ...
                <!DOCTYPE html>
                    ...
                    <body>
                      <div class=\"form-style-5\">
                        <form method=\"post\" action=\"EditBook2.php\">
                            <fieldset>
                                ...
                                <input type=\"text\" name=\"BTitle\" placeholder=\"Book Title *\" value=\"$tab[1]\">
                                <input type=\"text\" name=\"Author\" placeholder=\"Author *\" value=\"$tab[2]\">
                                <input type=\"text\" name=\"PHouse\" placeholder=\"Publishing House *\" value=\"$tab[3]\" >
                                <input type=\"text\" name=\"PNumber\" placeholder=\"Pages Number *\" value=\"$tab[4]\">
                                <input type=\"text\" name=\"INumber\" placeholder=\"Items Number *\" value=\"$tab[5]\">
                                <input type=\"hidden\" name=\"AncienINumber\" value=\"$tab[5]\">
